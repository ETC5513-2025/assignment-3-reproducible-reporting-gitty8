...
rect(1, 16, 9, 19.5, col = box_color, border = "black", lwd = 2)
text(5, 17.75, "Step 1\nMerge QS Rankings 2024 & 2025 Data", 
     cex = 1.3, font = 2, adj = 0.5)

rect(1, 12, 9, 15.5, col = box_color, border = "black", lwd = 2)
text(5, 13.75, "Step 2\nIdentify Top 10 Countries from QS Rankings", 
     cex = 1.3, font = 2, adj = 0.5)

rect(1, 8, 9, 11.5, col = box_color, border = "black", lwd = 2)
text(5, 9.75, "Step 3\nFilter Kaggle Dataset for These 10 Countries", 
     cex = 1.3, font = 2, adj = 0.5)

rect(1, 4, 9, 7.5, col = box_color, border = "black", lwd = 2)
text(5, 5.75, "Step 4\nSelect Master Level Programs Only", 
     cex = 1.3, font = 2, adj = 0.5)

rect(1, 0, 9, 3.5, col = box_color, border = "black", lwd = 2)
text(5, 1.75, "Step 5\nCalculate Total Study Cost", 
     cex = 1.3, font = 2, adj = 0.5)

arrows(5, 16, 5, 15.5, length = 0.15, lwd = 3, col = "darkblue")
arrows(5, 12, 5, 11.5, length = 0.15, lwd = 3, col = "darkblue")
arrows(5, 8, 5, 7.5, length = 0.15, lwd = 3, col = "darkblue")
arrows(5, 4, 5, 3.5, length = 0.15, lwd = 3, col = "darkblue")
```
...
1. *Kaggle. (2024). Cost of International Education Dataset.* Retrieved from  

<https://www.kaggle.com/datasets/adilshamim8/cost-of-international-education>

2. *QS World University Rankings 2024.* Retrieved from  

<https://www.kaggle.com/datasets/darrylljk/worlds-best-universities-qs-rankings-2025>

3.  *QS World University Rankings 2025.* Retrieved from  
